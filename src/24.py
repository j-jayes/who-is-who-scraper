...
# average distance overall for all sectors
all_distances = [distance for distances in sector_distances.values() for distance in distances]

print(f"Average distance overall: {sum(all_distances)/len(all_distances):.2f} km")