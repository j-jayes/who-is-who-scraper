...
ggsave("figures/hisco_counts.png", width = 20, height = 10, units = "cm", dpi = 300)
...
data %>%
    ...
    ggplot(aes(x = Average_Distance, y = Sector)) +
    geom_col(fill = "#d95f02", alpha = .8) +
    scale_x_continuous(labels = scales::number_format()) +
...
labs(x = "Number of people", y = "Occupation", fill = "Degree level") 
```
