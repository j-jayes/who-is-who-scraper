...
occupation_embeddings = load_json_file('data/careers/career_embeddings.json')
hisco_embeddings = load_json_file('data/careers/sector_embeddings.json')
...
hisco_codes = pd.read_excel("data/careers/industrial_groupings.xlsx")

# select the column we want, number
hisco_codes = hisco_codes[['sector']]
...
with open('data/careers/closest_sector_matches.json', 'w', encoding='utf-8') as f:
